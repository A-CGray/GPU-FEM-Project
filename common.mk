...
TACS_OPT_CC_FLAGS = ${EXTRA_CC_FLAGS}
TACS_DEBUG_CC_FLAGS = ${EXTRA_DEBUG_CC_FLAGS}
...
GPU_TACS_LD_FLAGS = ${GPU_TACS_LD_CMD} -Xlinker "${EXTRA_LD_FLAGS} ${TACS_EXTERN_LIBS}" ${MPI_LIB} ${CUDA_LIBS}
